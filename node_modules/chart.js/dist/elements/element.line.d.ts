export default class LineElement extends Element<import("chart.js/dist/types/basic").AnyObject, import("chart.js/dist/types/basic").AnyObject> {
    static id: string;
    /**
     * @type {any}
     */
    ...
    _path: any;
    _points: any;
    _segments: import("chart.js/dist/helpers/helpers.segment").Segment[];
    _decimated: boolean;
    ...
    set points(arg: any);
    get points(): any;
    get segments(): import("chart.js/dist/helpers/helpers.segment").Segment[];
    /**
...
export type PointElement = import('chart.js/dist/elements/element.point').default;
