...
export type Unit = import('chart.js/dist/core/core.adapters').TimeUnit;
export type Interval = {
    common: boolean;
    size: number;
    steps?: number;
};
export type DateAdapter = import('chart.js/dist/core/core.adapters').DateAdapter;
import Scale from "chart.js/dist/core/core.scale";
