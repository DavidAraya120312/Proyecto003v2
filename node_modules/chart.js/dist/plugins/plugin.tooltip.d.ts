export class Tooltip extends Element<import("chart.js/dist/types/basic").AnyObject, import("chart.js/dist/types/basic").AnyObject> {
    /**
    ...
    options: any;
    dataPoints: {
        chart: import("chart.js/dist/core/core.controller").default;
        label: any;
        parsed: any;
        raw: any;
        formattedValue: any;
        ...
        dataIndex: number;
        datasetIndex: number;
        element: Element<import("chart.js/dist/types/basic").AnyObject, import("chart.js/dist/types/basic").AnyObject>;
    }[];
    title: any;
    beforeBody: any;
    body: any[];
...
export type Chart = import('chart.js/dist/platform/platform.base').Chart;
export type ChartEvent = import('chart.js/dist/types/index').ChartEvent;
export type ActiveElement = import('chart.js/dist/types/index').ActiveElement;
export type InteractionItem = import('chart.js/dist/core/core.interaction').InteractionItem;
import Element from "chart.js/dist/core/core.element";
import Animations from "chart.js/dist/core/core.animations";
